                    ...
                    if let profile = profileManager.profileInfo {
                        VStack(spacing: 15) {
                            ZStack {
                                ...
                                Circle()
                                    .trim(from: 0, to: CGFloat(profile.completionPercentage) / 100.0)
                                    .stroke(DesignSystem.cornYellow, style: StrokeStyle(lineWidth: 20, lineCap: .round))
                                    .frame(width: 150, height: 150)
                                    .rotationEffect(.degrees(-90))
                                    .animation(.easeInOut(duration: 1.0), value: profile.completionPercentage)
                        ...
                        if !missingFields.isEmpty {
                            VStack(alignment: .leading, spacing: 15) {
                                ...
                                .padding()
                                .background(DesignSystem.cornYellow.opacity(0.1))
                                .cornerRadius(12)
