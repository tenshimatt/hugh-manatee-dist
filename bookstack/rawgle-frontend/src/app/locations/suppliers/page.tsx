...
function SuppliersPage() {
  ...
  const [viewState, setViewState] = useState<ViewState>({
    type: 'map', // Default to map for suppliers
    selectedStore: null,
  ...
  useEffect(() => {
    try {
      const saved = localStorage.getItem('rawgle-suppliers-recent-searches')
      if (saved) {
  ...
  const updateRecentSearches = useCallback((searches: string[]) => {
    ...
    try {
      localStorage.setItem('rawgle-suppliers-recent-searches', JSON.stringify(searches))
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section - Focused on Raw Food Suppliers */}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl mb-8 text-white/90">
              Find farm-direct suppliers, butchers, co-ops, and specialty stores for quality raw pet food
            </p>
            ...
            {currentLocation && stores.stores.length > 0 && (
              <div className="mt-6 flex justify-center gap-6 text-sm">
                <div className="flex items-center gap-1">
                  ...
                  <span>{stores.stores.length} suppliers found</span>
                </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>{stores.stores.filter(s => s.isVerified).length} verified</span>
                </div>
              </div>
            )}
          </motion.div>
          ...
          <main className="lg:w-3/4" role="main">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
              <div className="flex-1">
                <h2 className="text-2xl font-bold" id="results-heading">
                  {stores.stores.length} Suppliers
                  {currentLocation && (
            ...
            {stores.loading && (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Finding suppliers near you...</p>
                </div>
              </div>
            )}
            ...
            {!stores.loading && stores.stores.length === 0 && currentLocation && (
              <Card className="p-12 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-900">No Suppliers Found</h3>
                <p className="text-gray-600 mb-4">
                  No raw pet food suppliers found within {storeFilters.filters.radius || 25} miles of your location.
                </p>
            ...
            {!stores.loading && stores.stores.length === 0 && !currentLocation && (
              <Card className="p-12 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-900">Find Suppliers Near You</h3>
                <p className="text-gray-600 mb-4">
                  Enter your location above or use your current location to discover raw pet food suppliers in your area.
                </p>
