...
## Stack (as of 2026-04-18)

- **Runtime**: Next.js 16 (App Router) + React 19
- **Styling**: Tailwind v4 + shadcn-style components (hand-written: Card, Badge)
- **Icons**: lucide-react
...
| `src/app/layout.tsx` | Root layout, dark mode default, Geist fonts |
| `src/app/globals.css` | Tailwind v4 theme tokens (oklch palette, radial gradient bg) |
...
- **Tailwind v4 + oklch tokens.** Modern colour space, theme-able. Dark mode is the default (no toggle) because this is an internal lab.
