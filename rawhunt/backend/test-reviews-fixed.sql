...
-- Create some test reviews (using correct column names)
INSERT INTO reviews (user_id, supplier_id, rating, comment, is_verified, created_at) VALUES 
...
(3, 4, 5, 'Knowledgeable staff helped me transition my rescue dog to raw food. The staff spent an hour explaining everything and gave me a feeding plan.', TRUE, '2024-01-25 15:30:00');