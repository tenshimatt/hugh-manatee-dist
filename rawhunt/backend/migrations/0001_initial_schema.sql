...
-- AI consultations indexes
CREATE INDEX idx_ai_consultations_user ON ai_consultations(user_id);
CREATE INDEX idx_ai_consultations_urgency ON ai_consultations(urgency);
CREATE INDEX idx_ai_consultations_date ON ai_consultations(created_at);